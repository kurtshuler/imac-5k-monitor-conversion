...
4. **SILENT** - One of the boards, the R1811, comes with a fan that people find noisy. So I kept the iMac's internal case fan to reuse that and maybe also run the R1811's board fan with some resistors.
